...
class CollaboratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collaborator" do
    assert_difference('Collaborator.count') do
      post collaborators_url, params: { collaborator: { contact: @collaborator.contact, institution: @collaborator.institution, link: @collaborator.link, name: @collaborator.name } }
    end
  ...
  test "should update collaborator" do
    patch collaborator_url(@collaborator), params: { collaborator: { contact: @collaborator.contact, institution: @collaborator.institution, link: @collaborator.link, name: @collaborator.name } }
