...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { country: @visitor.country, date: @visitor.date, name: @visitor.name, university: @visitor.university } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { country: @visitor.country, date: @visitor.date, name: @visitor.name, university: @visitor.university } }
